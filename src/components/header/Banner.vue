<template>
    <div v-if="isOpen" class="bg-surface-0 dark:bg-surface-950">
        <div class="bg-surface-900 text-surface-100 py-4 px-6 lg:px-20 flex justify-between items-center flex-wrap">
            ...
            <Button icon="pi pi-times" text rounded severity="secondary" class="text-surface-0! hover:bg-surface-500/20!" @click="close"/>
        </div>
    </div>
</template>
<script setup>
