<template>
  <Card style="max-width: 64rem">
    <template #title>Frequently Asked Questions</template>
    <template #subtitle>Excepteur sint occaecat cupidatat non proident, suntin culpa qui officia deserunt mollit anim id
      est laborum.</template>
    <template #content>
      <div class="card">
